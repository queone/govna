...
- Follow validation and Package rules in `AGENTS.md` and `govna/release.md`.
...
- Run `./build.sh` and confirm it passes when the change touches build-relevant files (skip for AC critique, doc-only review, design discussion).
