...
func TestTopLevelGeneratedVersionAxes(t *testing.T) {
	...
	auditMatches, err := filepath.Glob(filepath.Join(root, "govna", "ac*-audit-v0.66.0.md"))
	...
	removalMatches, err := filepath.Glob(filepath.Join(root, "govna", "ac*-govna-rm-v0.66.0.md"))
