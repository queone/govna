...
func TestAdoptionVersionAxesAndInstructions(t *testing.T) {
	...
	for _, want := range []string{
		...
		"Govna executable v9.8.7 added its embedded governance files (canon v0.54.0) for the CODE repository widget.",
		"Govna executable v9.8.7 added its embedded governance files (canon v0.54.0). The list below records whether each file was written, merged, or preserved.",
	...
	for _, invalid := range []string{"Applied govna v0.54.0", "Director reads", "review applied governance", "overlay", "consumer-owned"} {
