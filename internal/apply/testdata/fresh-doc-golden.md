...
Applied govna v0.33.0 governance template (DOC overlay) to handbook.

## Summary

Applied govna v0.33.0 governance template (DOC overlay). All files below are now consumer-owned — modify freely to fit the repo's needs.
