...
Applied govna v0.30.0 governance template (DOC overlay) to handbook.

## Summary

Applied govna v0.30.0 governance template (DOC overlay). All files below are now consumer-owned — modify freely to fit the repo's needs.
