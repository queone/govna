...
Applied govna v0.31.0 governance template (CODE overlay) to widget.

## Summary

Applied govna v0.31.0 governance template (CODE overlay). All files below are now consumer-owned — modify freely to fit the repo's needs.
