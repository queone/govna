...
The AC is the implementation contract for one approved roadmap item. The full editing cycle lives in `govna/editing-cycle.md`; `AGENTS.md` governs drafting, review, and integration.
