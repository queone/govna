...
The lifecycle makes recurring publishing checkpoints and their settled context reusable across phases and sessions. This reduces process reconstruction and avoidable rework without weakening authorization, review, verification, or release gates.
...
6. **Package.** Run `govna/release.md` publication preparation for the established Ratified release batch or direct batch only after separate Director authorization.
