...
func TestScopedPlainLanguageReplacements(t *testing.T) {
	...
	checks := []replacement{
		...
		{"internal/help/help.go", "Repo governance templates", "Add and maintain Govna governance files"},
		...
		{"internal/help/help.go", "print binary version", "print executable version"},
		{"cmd/govna/main.go", "govna binary:", "govna v%s\\nEmbedded governance-file version"},
