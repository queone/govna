# AC7 Govna Removal from v0.32.0

## Summary

Extricate govna canon from this consumer repo without deleting consumer-owned content. Emitted by `govna rm` against canon v0.32.0. Implement only after the Director resolves the routing decisions below.
