...
Govna executable v9.8.7 created this removal plan from its embedded governance files (canon v0.66.0). This AC removes Govna-managed content without deleting repository-owned content. Files needing a choice stay unchanged until the Director decides what to do.
